...
const PatientAppointments = () => {
  ...
  const loadAppointments = async () => {
    try {
      setIsLoading(true)
      const params: any = { limit: 50, sort: 'date' }
      if (filter === 'upcoming') {
        params.status = ['Pending', 'Confirmed', 'Scheduled']
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 text-white py-12">
        <div className="container-custom">
          ...
          <p className="text-white/90">View and manage all your appointments</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          {appointments.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <Link href="/patient/dashboard" className="text-primary-600 hover:text-primary-700 font-semibold">
                Book an appointment
              </Link>
            </div>
          )}
