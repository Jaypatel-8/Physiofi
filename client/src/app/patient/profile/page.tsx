            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900 font-medium">{formData.age} years</p>
                )}
              </div>
              ...
              <div className="md:col-span-2 border-t border-gray-200 pt-6">
                <h3 className="text-lg font-black text-gray-900 mb-4 font-display">Emergency Contact</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-900 font-medium">{formData.emergencyContact.name || 'Not set'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-900 font-medium">{formData.emergencyContact.phone || 'Not set'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-900 font-medium">{formData.emergencyContact.relation || 'Not set'}</p>
                    )}
                  </div>
                </div>
              </div>
