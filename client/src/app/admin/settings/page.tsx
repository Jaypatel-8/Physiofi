...
const AdminSettings = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DashboardHeader title="Settings" subtitle="Manage your administrator settings" />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get notified of system issues</p>
                  </div>
                  <button
                    onClick={() => handleNotificationChange('systemAlerts')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      notifications.systemAlerts ? 'bg-primary-500' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Monitor user activities</p>
                  </div>
                  <button
                    onClick={() => handleNotificationChange('userActivity')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      notifications.userActivity ? 'bg-primary-500' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        notifications.userActivity ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive system reports</p>
                  </div>
                  <button
                    onClick={() => handleNotificationChange('reports')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      notifications.reports ? 'bg-primary-500' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  <p className="font-semibold text-gray-900 mb-2">System Security</p>
                  <p className="text-sm text-gray-600">
                    All system data is encrypted and protected. Admin accounts have full access to system management.
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">
                    Your administrator account is protected with industry-standard security measures. Always keep your password confidential.
                  </p>
                </div>
              </div>
            </div>
