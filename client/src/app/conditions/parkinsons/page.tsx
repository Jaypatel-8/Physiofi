  ...
  return (
    <main className="min-h-screen">
      ...
      <ConditionHero
        ...
        description="Specialized physiotherapy for Parkinson's disease. Improve movement, balance, and quality of life with evidence-based treatment."
        imageAlt="Parkinson's disease physiotherapy treatment"
        imagePath="/therapies/neuro-physio.jpg"
      />

      <SymptomsList symptoms={symptoms} />
      <ImageSection imageAlt="Parkinson's disease rehabilitation illustration" imagePath="/therapies/balance-gait.jpg" />
