...
import { ArrowLeftIcon, UserGroupIcon, UserCircleIcon } from '@heroicons/react/24/outline'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-500 text-white py-12">
        <div className="container-custom">
          ...
          <h1 className="text-4xl font-black mb-2">My Patients</h1>
          <p className="text-white/90">View and manage your patient list</p>
        </div>
      </div>
