              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get notified of new appointment requests</p>
                  </div>
                  <button
                    onClick={() => handleNotificationChange('appointmentRequests')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      notifications.appointmentRequests ? 'bg-primary-500' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        notifications.appointmentRequests ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <p className="font-semibold text-gray-900">Patient Updates</p>
                    <p className="text-sm text-gray-600">Receive updates from patients</p>
                  </div>
                  <button
                    onClick={() => handleNotificationChange('patientUpdates')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      notifications.patientUpdates ? 'bg-primary-500' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        notifications.patientUpdates ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">
                    Your professional information is encrypted and stored securely. Patient data is handled with utmost confidentiality.
                  </p>
                </div>
